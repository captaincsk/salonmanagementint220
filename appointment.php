                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        <div class="footer-widget widget-newsletter">
                            ...
                            <p>Enter your email address to receive new services  information and other useful information right to your inbox.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="copyright-content">
                                <p>© C SAHIL KUMAR | all rights reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
